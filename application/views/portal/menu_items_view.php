<div class="row">
	...
	<div id="menu-item-wrapper" class="col-md-12">
		...
		<table class="table table-striped table-hover menu-item-table">
			...
			<?php foreach( $list as $menu_item ):?>
				<tr>
					<td class="text-center"><?=gen_ui_revise_button( site_url( 'admin/portal/menu_items/revise/' . $menu_item['menu_item_id'] ) );?></td>
				...
				<?php if( isset( $menu_item['children_list'] ) ):?>
					<?php foreach( $menu_item['children_list'] as $child ):?>
						<tr>
							<td class="text-center"><?=gen_ui_revise_button( site_url( 'admin/portal/menu_items/revise/' . $child['menu_item_id'] ) );?></td>
