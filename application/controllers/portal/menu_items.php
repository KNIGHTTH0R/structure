...
class Menu_items extends CI_Controller {
	...
	public function index() {
		...
		$params['list']						= $this->menu_items_model->menu_item_list( 'po' );
		
		$this->layout->view( 'portal/menu_items_view', $params );
	}
	...
	public function create() {
		...
		$this->layout->view( 'portal/menu_items_create_view', $params );
	}
	
	public function insert() {
		$menu_item = $this->menu_items_model->menu_item_insert();
		if( $menu_item ) {
			echo 's|created Menu Item|' . site_url( 'admin/portal/menu_items' );
		} else {
	...
	public function revise( $menu_item_id ) {
		...
		$this->layout->view( 'portal/menu_items_revise_view', $params );
	}
	
	public function update() {
		$menu_item = $this->menu_items_model->menu_item_update();
		if( $menu_item ) {
			echo 's|updated Menu Item|' . site_url( 'admin/portal/menu_items' );
		} else {
