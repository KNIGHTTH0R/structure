var Front_menu_items_list = function() {
	return {
		init: function() {
			$( document ).ready( function() {
				...
				$( "#sequence-list" ).sortable({
						...
						update: function() {
							...
							$.post( site_url + 'portal/front_menu_items/sequence', post_data );
						},
            opacity: 0.8,
            tolerance: "pointer",
            helper: "clone",
...
var Front_menu_items_create = function() {
	return {
		init: function() {
			$( '#menu-item-create' ).on( 'submit', function( e ) {
				...
				$.post( site_url + 'portal/front_menu_items/insert', form_data, function( data ) {
					gen_toastr( data );
				});
			});
		}
...
var Front_menu_items_revise = function() {
	return {
		init: function() {			
			$( '#menu-item-revise' ).on( 'submit', function( e ) {
				...
				var form_data = $( this ).serialize();
				$.post( site_url + 'portal/front_menu_items/update', form_data, function( data ) {
					gen_toastr( data );
				});
			});
